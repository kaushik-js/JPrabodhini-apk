...
public class newLogin extends AppCompatActivity {
   ...
   ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aad = new ArrayAdapter<String>(newLogin.this,R.layout.support_simple_spinner_dropdown_item,listItems);
        list.setAdapter(aad);
    ...
    public void saved(View view)
    {
        ...
        db.collection("phonelogin").document(upn).set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(newLogin.this, "SAVED", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void deleted(View view)
    {
        ...
        db.collection("phonelogin").document(upn).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(newLogin.this, "DELETED", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
